...
CIMGUI_API int igIsWindowAppearing()
{
    return ImGui::IsWindowAppearing();
}
CIMGUI_API int igIsWindowCollapsed()
{
...
CIMGUI_API ImVec2_Simple igGetWindowPos()
{
	ImVec2 x = ImGui::GetWindowPos();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetWindowSize()
{
	ImVec2 x = ImGui::GetWindowSize();
    return *(ImVec2_Simple*)&x;
}
...
CIMGUI_API ImVec2_Simple igGetContentRegionMax()
{
	ImVec2 x = ImGui::GetContentRegionMax();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetContentRegionAvail()
{
...
CIMGUI_API ImVec2_Simple igGetWindowContentRegionMin()
{
	ImVec2 x = ImGui::GetWindowContentRegionMin();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetWindowContentRegionMax()
{
	ImVec2 x = ImGui::GetWindowContentRegionMax();
    return *(ImVec2_Simple*)&x;
}
...
CIMGUI_API ImVec2_Simple igGetFontTexUvWhitePixel()
{
	ImVec2 x = ImGui::GetFontTexUvWhitePixel();
    return *(ImVec2_Simple*)&x;
}
...
CIMGUI_API ImVec2_Simple igGetCursorPos()
{
	ImVec2 x = ImGui::GetCursorPos();
    return *(ImVec2_Simple*)&x;
}
...
CIMGUI_API ImVec2_Simple igGetCursorStartPos()
{
	ImVec2 x = ImGui::GetCursorStartPos();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetCursorScreenPos()
{
	ImVec2 x = ImGui::GetCursorScreenPos();
    return *(ImVec2_Simple*)&x;
}
...
CIMGUI_API int igBeginMainMenuBar()
{
...
CIMGUI_API int igBeginDragDropTarget()
{
...
{
	unsigned int x = ImGui::IsItemHovered(flags) ? 1 : 0;
    return x;
}
CIMGUI_API int igIsItemActive()
{
    return ImGui::IsItemActive();
}
CIMGUI_API int igIsItemFocused()
{
...
CIMGUI_API int igIsItemVisible()
{
    return ImGui::IsItemVisible();
}
CIMGUI_API int igIsItemEdited()
{
    return ImGui::IsItemEdited();
}
CIMGUI_API int igIsItemActivated()
{
    return ImGui::IsItemActivated();
}
CIMGUI_API int igIsItemDeactivated()
{
    return ImGui::IsItemDeactivated();
}
CIMGUI_API int igIsItemDeactivatedAfterEdit()
{
    return ImGui::IsItemDeactivatedAfterEdit();
}
CIMGUI_API int igIsAnyItemHovered()
{
    return ImGui::IsAnyItemHovered();
}
CIMGUI_API int igIsAnyItemActive()
{
    return ImGui::IsAnyItemActive();
}
CIMGUI_API int igIsAnyItemFocused()
{
    return ImGui::IsAnyItemFocused();
}
CIMGUI_API ImVec2_Simple igGetItemRectMin()
{
	ImVec2 x = ImGui::GetItemRectMin();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetItemRectMax()
{
	ImVec2 x = ImGui::GetItemRectMax();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetItemRectSize()
{
	ImVec2 x = ImGui::GetItemRectSize();
    return *(ImVec2_Simple*)&x;
}
...
{
	ImVec2 x = ImGui::CalcTextSize(text,text_end,hide_text_after_double_hash,wrap_width);
    return *(ImVec2_Simple*)&x;
}
...
{
	ImVec4 x = ImGui::ColorConvertU32ToFloat4(in);
    return *(ImVec4_Simple*)&x;
}
...
CIMGUI_API int igIsAnyMouseDown()
{
...
{
	ImVec2 x = ImGui::GetMousePos();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetMousePosOnOpeningCurrentPopup()
{
	ImVec2 x = ImGui::GetMousePosOnOpeningCurrentPopup();
    return *(ImVec2_Simple*)&x;
}
CIMGUI_API ImVec2_Simple igGetMouseDragDelta(int button,float lock_threshold)
{
	ImVec2 x = ImGui::GetMouseDragDelta(button,lock_threshold);
    return *(ImVec2_Simple*)&x;
}
...
{
	ImColor x = self->HSV(h,s,v,a);
    return *(ImColor_Simple*)&x;
}
...
{
	ImVec2 x = self->CalcTextSizeA(size,max_width,wrap_width,text_begin,text_end,remaining);
    return *(ImVec2_Simple*)&x;
}
